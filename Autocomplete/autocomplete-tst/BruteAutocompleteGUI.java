 ...
 *  Compilation:  javac BruteAutocompleteGUI.java
 *  Execution:    java  BruteAutocompleteGUI input.txt k
 *  Dependencies: In.java BruteAutocomplete.java
 *    
 *  Interactive GUI used to demonstrate the BruteAutocomplete data type.
 *
 ...
 *
 *  
 *  % java BruteAutocompleteGUI cities.txt 10
 *
 *************************************************************************/
...
public class BruteAutocompleteGUI extends JFrame {
    ...
    public BruteAutocompleteGUI(String filename, int k) {
        this.k = k;
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        setTitle("Brute Autocomplete");
    ...
    private class AutocompletePanel extends JPanel {
        ...
        private BruteAutocomplete auto;
        ...
        // private final int DEF_COLUMNS = 20;
        // private final String suggListLen = "this is how wide the listbox needs to be   ";
        ...
        public AutocompletePanel(String filename) {
            ...
            auto = new BruteAutocomplete(terms, weights);
            ...
            if (text.equals("")) {
                ...
                if (!resultQ.isEmpty()) {
                    ...
                    for (int i = 0; i < results.length; i++) {
                        ...
                        results[i] = "<html>" + results[i].substring(0, textLen) + "<b>" + results[i].substring(textLen) + "</b></html>";
                    }
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                new BruteAutocompleteGUI(filename, k).setVisible(true);
            }
        });
    }
}
